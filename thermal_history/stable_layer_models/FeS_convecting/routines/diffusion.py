...
def LHS_discont(x, x_discont, dx, dt, D_lower, D_upper, k_lower, k_upper, l_type, u_type, coord='spherical'):
    ...
    x : array
        position array
    x_discont : float
        x position of discontinuity
    dx : array
        array containing grid spacings.
    dt : float
        time step
    D_lower : float
        diffusivity of the lower region
    D_upper : float
        diffusivity of the upper region
    k_lower : float
        conductivity of the lower region
    k_upper : float
        conductivity of the upper region
    l_type : int
        Lower boundary condition type (0: dirichlet, 1: neumann)
    u_type : int    
        Upper boundary condition type (0: dirichlet, 1: neumann)
